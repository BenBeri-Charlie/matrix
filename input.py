...
if __name__ == "__main__":
    ...
    for param in calls:
        if isinstance(dictionary[param], list) and not (isinstance(dictionary[param][0], int) or isinstance(dictionary[param][0], float)):
            for i in range(len(dictionary[param])):
                for j in range(len(dictionary[param][i])):
                    print(dictionary[param][i][j], '', end='')
                print()
        elif isinstance(dictionary[param], list) and (isinstance(dictionary[param][0], int) or isinstance(dictionary[param][0], float)):
            for i in range(len(dictionary[param])):
                print(dictionary[param][i], '', end='')
            print()
        else:
